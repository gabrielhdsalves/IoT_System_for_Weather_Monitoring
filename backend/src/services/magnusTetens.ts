...
export function analyzesPotentialRain(
    ...
    if (pw < 20) {
        ...
        statusCombustivel = 'Umidade Moderada. Possibilidade de chuvas isoladas se houver forçante.';
    } else if (pw >= 30 && pw <= 50) {
        statusCombustivel = 'Ambiente Úmido. Potencial para pancadas de chuva de verão.';
    } else {
        statusCombustivel = 'Extrema umidade. Cenário típico de tempestades severas.';
    }
